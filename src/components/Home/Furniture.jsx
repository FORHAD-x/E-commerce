...
const Furniture = () => {
  ...
  return (
    <>
    <section className='Furniture  pb-[50px] border-b-1 border-[#D9D9D9]'>
      <div className="text-center px-4 mb-8">
        <p className="font-Poppins font-semibold text-[16px] sm:text-[18px] md:text-[20px] text-secondary">
          Share your setup with
        </p>
        <h2 className="font-Poppins font-bold text-[28px] sm:text-[32px] md:text-[40px] text-primary">
          #FurniroFurniture
        </h2>
      </div>
